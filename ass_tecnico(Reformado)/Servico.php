...
<body>
	...
	<label>Você tem aparelhos(os) danificados? Aqui tem a possibilidade<br>&nbsp de cadastrar serviços.&nbsp;E acessar a sua ordem de serviço.</label>
	<br><br><br><br>
	<a href="#bg">CADASTRAR SERVIÇOS</a>
	<img name="slide" class="sli">
    </div>
    ...
    <div class="bvc">
		...
		<br>
		<p>
			Olá, esperamos que goste de como trabalhamos no nosso site. 
			<br><br>
			Aqui você fica por dentro de como anda o seu serviço.
		</p>
	</center>
    </div>
    <div class="white">
	...
	<figure>
		...
		<figcaption>
			...
			<label>
				...
				<p>
					<br>
					dispostos a solucionar o problema de Segunda a Sábado a partir das 7:00 às 17:00
					<br><br>
				</p>
			</label>
			<br>
		...
		<figcaption>
			...
			<label>
				...
				<br>
					...
					Temos assistência para todos os modelos de celulares, tablet e notebook. E mais, trabalhamos com aparelhos domésticos de todas as MARCAS.  
										<br><br>
				</p>
			</label>
			<br>
	...
	<figure>
		...
		<figcaption>
			...
			<label>
				...
				<p>
				<br>
					E-mails: ejjlmanuteções@gmail.com<br>
...
<div class="nave">
  ...
  <br>
    ...
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="#bg2">ORDEM DE SERVIÇOS</a></label><br>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="#bg">CADASTRO</a></label><br>
  <br><br><br><br>
</div>
<div class="servi">
   <br>
      ...
      <hr><br>
      <label>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Manutenção de Eletrodomésticos<br> 
